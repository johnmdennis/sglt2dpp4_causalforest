...
#Model predicted treatment difference
  ...
  final$DPP4.pred.lm2 <- predict(full.pen.m1,final)
  final <- final %>% mutate(drug="SGLT2")
  final$SGLT2.pred.lm2 <- predict(full.pen.m1,final)
  final <- final %>% 
    mutate(hba1c_diff2 = SGLT2.pred.lm2-DPP4.pred.lm2) %>%
    mutate(bestdrug2=ifelse(hba1c_diff<=0,"SGLT2","DPP4"))
  head(final)
